...
function create() {
    ...
    gameState.rect1.on('pointerover', function() {
        if (gameState.rect1.fillColor === gameState.onColor) {
            gameState.rect1.fillColor = gameState.offColor;
            gameState.rect2.fillColor = gameState.onColor;
        } else {
    ...
    gameState.rect1.on('pointerout', function() {
      if (gameState.rect1.fillColor === gameState.onColor) {
          gameState.rect1.fillColor = gameState.offColor;
          gameState.rect2.fillColor = gameState.onColor;
      } else {
    ...
    gameState.rect2.on('pointerout', function() {
      if (gameState.rect1.fillColor === gameState.onColor) {
          gameState.rect1.fillColor = gameState.offColor;
          gameState.rect2.fillColor = gameState.onColor;
      } else {
...
The .on() method takes two arguments: the name of the event ('pointerup') and the callback function. We create a new function as the second argument, with one line inside of it: reassigning this.fillColor. Updating this.fillColor changes the color of the circle (that’s why this is here).
